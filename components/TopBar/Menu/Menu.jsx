...
import { setCanvasBackground } from "@/components/Redux/reducers/canvasSlice";
import { setElement } from "@/components/Redux/reducers/elementSlice";
          ...
          <div className="fixed top-3 left-2 flex-row">
            {recording === true ? (
              <Circle
                color="red"
                fill="red"
                className=" absolute h-2 w-2 justify-center items-center"
              ></Circle>
            ) : null}
            <Button
              onClick={() => { }}
            ...
            {recording === true ? (
              ...
              >
                <Circle
                  color="red"
                  fill="red"
                  className="absolute mb-2 mr-4 h-2 w-2 justify-center items-center"
                ></Circle>
                <Video className="mr-2 h-4 w-4" />
